...
2. **Watched:** The **Cinephile Vault & Diary** (live count badge `Badge { 1130 }`). Features a streamlined layout dedicating over 90% of screen space to movie browsing with a slim sticky search/sort/view-mode bar, and a collapsible summary card (`🎬 1,130 Films • ~2,071h • ★ 7.2 • ~7.0/mo`). Inside the scrollable view or expanded card, access the full **Cinephile Viewing Analytics Hub** featuring:
   ...
   - **Cinema Eras & Decades Breakdown:** Visual progress bars from 2020s down to Pre-1970s with 1-tap filtering.
