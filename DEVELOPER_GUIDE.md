...
3. **UI (Jetpack Compose)**
   ...
   - **HomeScreen.kt**: Monolithic navigation and screen layout:
     ...
     - *Agent Chat Tab (3)*: Conversational AI assistant (Olivia) routed through Gemini 2.0 Flash or local Ollama, featuring 1-tap quick action prompt chips.
